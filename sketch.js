...
function setup() {
 ...
 //invisibleground2.visible=false;
  ...
  ground = createSprite(0,windowHeight-110,windowWidth*10,20);
  ground.shapeColor="green";
  ground.visible=false;
  //ground.addImage(groundimg);
  mario=createSprite(30,650,40,40);
...
mine= createSprite(440,windowHeight-120,40,40);
mine.addImage(mineimg);
mine.scale=0.06;


mine2= createSprite(940,windowHeight-120,40,40);
mine2.addImage(mineimg);
mine2.scale=0.06;

mine3= createSprite(1880,windowHeight-120,40,40);
mine3.addImage(mineimg);
mine3.scale=0.06;


mine4= createSprite(1040,windowHeight-620,40,40);
mine4.addImage(mineimg);
mine4.scale=0.06;


mine5= createSprite(2140,windowHeight-620,40,40);
mine5.addImage(mineimg);
mine5.scale=0.06;


mine6= createSprite(2200,windowHeight-720,40,40);
mine6.addImage(mineimg);
mine6.scale=0.06;


mine7= createSprite(2700,windowHeight-120,40,40);
mine7.addImage(mineimg);
mine7.scale=0.06;

mine8= createSprite(2880,windowHeight-520,40,40);
mine8.addImage(mineimg);
mine8.scale=0.06;


mine9= createSprite(3000,windowHeight-720,40,40);
mine9.addImage(mineimg);
mine9.scale=0.06;


mine10= createSprite(3240,windowHeight-320,40,40);
...
pillar=createSprite(300,windowHeight-200,40,100)
pillar.addImage(pillarimg);
pillar.scale=0.2;


pillar2=createSprite(800,windowHeight-200,40,100)
pillar2.addImage(pillarimg);
pillar2.scale=0.2


pillar3=createSprite(900,windowHeight-200,40,100)
pillar3.addImage(pillarimg);
pillar3.scale=0.2;


pillar4=createSprite(1400,windowHeight-140,40,100)
pillar4.addImage(pillarimg);
pillar4.scale=0.08;


pillar5=createSprite(2400,windowHeight-220,40,100)
pillar5.addImage(pillarimg);
pillar5.scale=0.3;


pillar6=createSprite(2200,windowHeight-180,40,100)
pillar6.addImage(pillarimg);
pillar6.scale=0.15;
//pillar.debug=true;

pillar7=createSprite(2700,windowHeight-140,40,100)
pillar7.addImage(pillarimg);
pillar7.scale=0.11;


pillar8=createSprite(3200,windowHeight-220,40,100)
pillar8.addImage(pillarimg);
pillar8.scale=0.25


pillar9=createSprite(3500,windowHeight-220,40,100)
pillar9.addImage(pillarimg);
pillar9.scale=0.2;


pillar10=createSprite(3800,windowHeight-130,40,100)
pillar10.addImage(pillarimg);
pillar10.scale=0.08;


pillar11=createSprite(4000,windowHeight-180,40,100)
pillar11.addImage(pillarimg);
pillar11.scale=0.3;


pillar12=createSprite(3000,windowHeight-180,40,100)
pillar12.addImage(pillarimg);
pillar12.scale=0.15;
//
//
//eftButton = createSprite(mario.x-50,500);
//eftButton.addImage(leftimg);
//eftButton.scale=0.1
//
//ightbutton = createSprite(mario.x-50,500);
//ightbutton.addImage(rightimg);
//ightbutton.scale=0.3
//
//umpbutton = createSprite(mario.x-150,500);
//umpbutton.addImage(jumpimg);
//umpbutton.scale=0.2;

//rightbutton.debug=true;
Engine.run(engine);
...
//jumpbutton.x = mario.x-200;
//rightbutton.x = mario.x-100;
   ...
   //jumpbutton.setCollider("rectangle",0,0,pillar.width-1200,pillar.height-1050);
  ...
  if(keyIsDown(UP_ARROW) && mario.y>=600 ){
 ...
 if(touchStarted.length>0 && mario.y>=600){
    mariojump.setVolume(0.15);
    mario.velocityY = -22;
   mariojump.play()
  } 
  ...
  if(gameState===END){
    ...
    gameover33=createSprite(mario.x,300,180,300);
...
if(gameState===FINISH){
     gameover4=createSprite(mario.x,300,180,300);
...
function touchStarted(){
  if(touchStarted(rightbutton)){
    mario.x+=10
    mario.changeAnimation("leftrunning",marioleftAnimation)
  }
  if(touchStarted(leftButton)){
    mario.x-=10
    mario.changeAnimation("leftrunning",marioleftAnimation)
  }
  if(touchStarted(jumpbutton && mario.y===597.5 )){
    mariojump.setVolume(0.15);
    mario.velocityY = -17;
   mariojump.play()
  } 
